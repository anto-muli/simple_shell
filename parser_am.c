#include "shell.h"
/**
 * confirm_cmd - Determines whether a file at the given path
 ...
 */
int confirm_cmd(info_t *info, char *path)
{
	struct stat st;
...
/**
 * clone_chars - a range of characters from a given PATH string.
 *
...
/**
 * detect_path - find all path of a command within the PATH string.
 *
